...
import com.wyy.zhbj.domain.PhotosBean;
import com.wyy.zhbj.domain.PhotosBean.PhotoNews;
import com.wyy.zhbj.global.GlobalConstants;
import com.wyy.zhbj.utils.CacheUtils;
import com.wyy.zhbj.utils.MyBitmapUtils;
...
public class PhotosMenuDetailPager extends BaseMenuDetailPager implements OnClickListener{
	...
	private void getDataFromServer() {
		...
		utils.send(HttpMethod.GET,GlobalConstants.PHOTOS_URL,new RequestCallBack<String>() {
			...
			public void onSuccess(ResponseInfo<String> responseInfo) {
				...
				processData(result);
				CacheUtils.setCache(GlobalConstants.PHOTOS_URL, result,mActivity);//设置缓存
	...
	protected void processData(String result) {
		...
		// gridview的布局结构和listview完全一致,所以可以共用一个adapter
